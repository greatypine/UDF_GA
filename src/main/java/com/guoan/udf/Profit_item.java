...
public class Profit_item extends UDF {
	...
	public Double evaluate(double trading_price, int quantity, String joint_ims, String order_tag3, int teptag1,
			String business_type, double cost_price, double c_cost_price, String contract_method,
			double contract_percent, double contract_price, double proration_seller_price, String department_id) {
	...
	/**
	 * Title: normal_calculate Description: 正常第三方合同计算毛利 / 或者其他计算毛利方法
	 * 
	 ...
	 * @return
	 */
	public double normal_calculate(double trading_price, double cost_price, String contract_method,
	 ...
	 * 12. double proration_seller_price
	 * 13. String department_id
	 */
